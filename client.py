...
print "  ESTOP IN:\t\t" + str(di[0])
print "  RESET:\t\t" + str(di[1])
print "  ROBOT PROXIMITY:\t" + str(di[2])
print ""
print "Input Registers:"
print "  MACHINING TIME:\t" + str(ir[0])
print "  MODE:\t\t\t" + str(ir[1])
print ""
print "Coils:"
print "  ESTOP OUT:\t\t" + str(co[0])
print "  DOOR CLOSED:\t\t" + str(co[1])
print "  CHUCK CLOSED:\t\t" + str(co[2])
print "  STOCK PRESENT:\t" + str(co[3])
print ""
print "Holding Registers:"
print "  STATE:\t\t" + str(hr[0])
print "  MODE:\t\t\t" + str(hr[1])
print "  PROGRESS:\t\t" + str(hr[2])
print "  PART COUNT:\t\t" + str(hr[3])
print "  HEATBEAT COUNTER:\t" + str(hr[4])
print ""
#---------------------------------------------------------------------------#
# close the client
#---------------------------------------------------------------------------#
